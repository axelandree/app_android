...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonItem, IonLabel, IonInput, IonButton, IonButtons, IonIcon,IonToggle } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [IonHeader, IonToolbar, IonTitle, IonContent, IonItem, IonLabel,
            IonInput, IonButton, FormsModule, NgClass, NgFor, IonModal, NgIf,IonButtons, IonToggle],
})
export class HomePage {
  ...
  onTouchEnd() {
    ...
    // 👇 si baja más de 120px → cerrar
    if (this.desplazamientoY > 120) {
      this.desplazamientoY = 500;
      setTimeout(() => {
        this.cerrarRanking();
      }, 200);
    } else {
